...
class Admin extends Controller {
                ...
                if($this->check()){
                        ...
                        if ($this->form_validation->submitted())
                        {
                                ...
                                $upresult = $this->staff_model->upload();
                                        if ($upresult) {
                                                if($this->staff_model->insert_staff($this->io->post('firstname'), $this->io->post('lastname'), $this->io->post('position'), $this->io->post('birthday'), $this->io->post('age'), $this->io->post('gender'), $this->io->post('email'), $this->io->post('cnumber'), $this->io->post('address'), $upresult)) 
                                                {
        ...
        public function edit_post($id) {
                if($this->check()){
                        ...
                        $userdata = $this->admin_model->get_data();
                        $inquirycount = $this->admin_model->get_inquiry_count();
                        $data = array($userdata, $inquirycount, $postdata);
                        ...
                        if ($this->form_validation->submitted())
                        {
                                ...
                                if ($this->form_validation->run()){
                                        if($_FILES['fileToUpload']['name'] == '')
                                        {
                                                ...
                                                if($this->staff_model->update_data($this->io->post('staff_id'), $this->io->post('firstname'), $this->io->post('lastname'), $this->io->post('position'), $this->io->post('birthday'), $this->io->post('age'), $this->io->post('gender'), $this->io->post('email'), $this->io->post('cnumber'), $this->io->post('address'), $this->io->post('photo'))) 
                                                {
                                                ...
                                                $staffid = $this->io->post('staff_id');
                                                if($upresult){
                                                        if($this->staff_model->update_data($this->io->post('staff_id'), $this->io->post('firstname'), $this->io->post('lastname'), $this->io->post('position'), $this->io->post('birthday'), $this->io->post('age'), $this->io->post('gender'), $this->io->post('email'), $this->io->post('cnumber'), $this->io->post('address'), $upresult)) 
                                                        {
                                                                $this->session->set_flashdata(array('success' => 'User was successfully updated!'));
                                                                redirect('admin/edit_staff/' . $staffid);
                                                                exit();
        ...
        public function admin_profile(){
                if($this->check()){
                        ...
                        $this->call->view('admin/admin_profile', $data);
                }
        }
                         ...
                         if ($this->form_validation->submitted())
                        {
                                ...
                                if ($this->form_validation->run()){
                                        ...
                                        if($this->admin_model->change_password($id, $this->io->post('oldpass'), $this->io->post('newpass'), $this->io->post('confirmpass')))
                                        {
                                                ...
                                                $this->session->set_flashdata(array('error' => 'ERROR! Admin password not updated!'));
                ...
                if($this->check()){
                        if ($this->form_validation->submitted())
                        {
                                ...
                                if ($this->form_validation->run()){
                                        ...
                                        if($this->send_email($email, $subject, $content))
                                        {
                                                $this->session->set_flashdata(array('success' => 'Inquiry reply was successfully sent to ' . $email));
                                                redirect('admin/inquiry/'.$id); //success, email sent for otp
                                                exit();
                                                        
                                        }
                                        else{  
                                                $this->session->set_flashdata(array('error' => 'ERROR! Inquiry reply was not sent to ' . $email . ' Try again'));    
                                                redirect('admin/inquiry/'.$id); //Error, email not sent
                                                exit();
                                        }
                                }
                        }
