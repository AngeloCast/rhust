					...
					<?php
				        ...
				        if(!empty($data[0])){
							...
							<div class="col-sm-12 blog-grid-left">
									<div class="imgcard">
										<a href="http://localhost/rhu/home/view_post/'.$news['id'].'"><img class="card_image" src="http://localhost/rhu/public/images/'.$news['photo'].'"  alt="news img" ></a>
										
										<h5><a href="http://localhost/rhu/home/view_post/'.$news['id'].'">'.$news['title'].'</a></h5>
										<div class="shorten">'.$news['content'].'</div>
										<div class="sub-meta">					
											<span><i class="fa fa-clock"></i> '. $news['date'].'</span>
											<a href="http://localhost/rhu/home/view_post/'.$news['id'].'" style="float: right; font-size: 14px;" href="">Read More >></a>	
										</div>
										</div>
									</div>
							</div><hr>';
