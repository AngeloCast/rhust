								...
								<?php 
									if(empty($data[2])){
										...
										foreach ($data[2] as $allevents => $events) {
											...
											<span class="badge"><a href="#details_'.$events['id'].'" class="btn btn-info btn-sm" data-toggle="modal" href="http://localhost/rhu/home/view_post/'.$events['id'].'">Details <i class="fa fa-info-circle"></i></a></span>
											</li>
