...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-info-circle"></i> <strong>Health Information</strong>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Health Information</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div style="text-align: center; margin-bottom: 20px;">
            <a style="width: 200px;" href="<?=site_url('admin/new_post/health_info'); ?>" class="btn btn-primary btn-md btn-flat"> NEW POST <i class="fa fa-pencil"></i></a>
          </div>
          <div class="box">
