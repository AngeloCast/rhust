        ...
        <div class="col-lg-3 col-xs-3">
          ...
          <div class="small-box bg-red">
            ...
            <div class="icon">
             ...
             <a href="<?=site_url('admin/patient_records'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> 
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-3">
        ...
        <div class="col-lg-3 col-xs-3">
          ...
          <div class="small-box bg-green">
            ...
            <div class="icon">
              ...
              <a href="<?=site_url('admin/inquiries'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
