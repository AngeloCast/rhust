    ...
    <section class="content">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 mx-auto">
            ...
            <div class="box">
              <br>
              <div class="box-body">
                <form class="form-horizontal" action="<?=site_url('admin/update_admin');?>" method="post" enctype="multipart/form-data">
                  <div class="col-sm-3">
                    <img src="<?php echo BASE_URL . PUBLIC_DIR . '/images/' . $data[0]['photo']; ?>" style="margin-bottom: 10px; margin-top: 10px; height: 100%; width: 100%; max-height: auto; max-width: auto; border: solid 1px gray;">
                  ...
                  <div class="col-sm-9">
                    ...
                    <h4 style="color: white; background-color: teal; font-weight: bold; padding: 10px;">ADMIN INFORMATION </h4>
        ...
        <div class="col-sm-12 mx-auto">
            <div class="box">
              <br>
              <div class="box-body">
                <form class="form-horizontal" action="<?=site_url('admin/admin_password');?>" method="post">
