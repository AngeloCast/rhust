...
<!-- CALANGATAN MODAL -->
<div class="modal fade" id="chart_calangatan" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-line-chart"></i>PATIENT RECORDS IN CALANGATAN</h5>
                    ...
                    <!-- small box -->
                      <div class="small-box male_box">
                        ...
                        <div class="icon">
                          ...
                          ?>
                          <b style="font-size: 30px"><?php  echo $data[13]['calangatanmale']['mrow']; ?></b>
                        </div>
                      </div>
                  </div>
                    ...
                    <!-- small box -->
                      <div class="small-box female_box">
                        ...
                        <div class="icon">
                          ...
                          <b style="font-size: 30px"><?php  echo $data[13]['calangatanfemale']['frow']; ?></b>
                        </div>
                      </div>
                  </div>
                    ...
                    <!-- small box -->
                      <div class="small-box other_box">
                        ...
                        <div class="icon">
                          ...
                          ?>
                          <b style="font-size: 30px"><?php  echo $data[13]['calangatanother']['orow']; ?></b>
                        </div>
                      </div>
                  </div>
                </div>
                ...
                <div class="row">
                      <div class="col-sm-6" style="border: solid 1px dimgray; border-radius: 5px; padding: 10px;">
                        <div class="card">
                          ...
                          <div class="card-body">
                            <canvas id="piecalangatan"></canvas>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6" style="border: solid 1px dimgray; border-radius: 5px; padding: 10px;">
                        <div class="card">
                            ...
                            <div class="card-body">
                              <canvas id="chartcalangatan"></canvas>
                            </div>
                        </div>
                      </div>
                </div>
