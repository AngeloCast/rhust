...
<!-- ILAG MODAL -->
<div class="modal fade" id="chart_ilag" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-line-chart"></i>PATIENT RECORDS IN ILAG</h5>
                    ...
                    <!-- small box -->
                      <div class="small-box male_box">
                        ...
                        <div class="icon">
                          ...
                          ?>
                          <b style="font-size: 30px"><?php  echo $data[13]['ilagmale']['mrow']; ?></b>
                        </div>
                      </div>
                  </div>
                    ...
                    <!-- small box -->
                      <div class="small-box female_box">
                        ...
                        <div class="icon">
                          ...
                          <b style="font-size: 30px"><?php  echo $data[13]['ilagfemale']['frow']; ?></b>
                        </div>
                      </div>
                  </div>
                    ...
                    <!-- small box -->
                      <div class="small-box other_box">
                        ...
                        <div class="icon">
                          ...
                          ?>
                          <b style="font-size: 30px"><?php  echo $data[13]['ilagother']['orow']; ?></b>
                        </div>
                      </div>
                  </div>
                </div>
