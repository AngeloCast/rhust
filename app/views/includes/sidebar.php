					...
					if(!empty($data[2])){
						...
						'<ul class="list-group single"><li class="list-group-item d-flex justify-content-between align-items-center" style="border: 3px dashed darkorange">
							<div class="col-12 text-center">
								...
								<h6 style="font-size: 13px; width: 100%; margin-top: 5px; color: #007eff; cursor: pointer;"><a class="anndetails" data-toggle="modal" data-id="'.$data[2]['id'].'">'.$data[2]['title'].' <i class="fa fa-info-circle"></i></a></h6>
