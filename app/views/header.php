			...
			<div class="row">
				<div class="col-md-4 logo text-left">
					<a class="navbar-brand" href="" style="color: #146e3c;">
						<img src="<?php echo BASE_URL . PUBLIC_DIR . '/images/MHOST_logo.jpg'; ?>" style="width: 60px;" alt="San Teodoro Logo"> RHU SAN TEODORO <i style="color: #146e3c;" class="fa fa-stethoscope"></i></a>
				</div>

				<div class="col-md-8 log-icons text-right">
								...
								if(isset($_SESSION['loggedin'])){
									...
									'<li class="nav-item dropdown">
										<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
										    aria-expanded="false">
										    <img id="user" src="http://localhost/rhu/public/images/'.$data[3]['photo'].'"> ' . $data[3]['fullname'] . '
										</a>
										<div class="dropdown-menu" aria-labelledby="navbarDropdown">
											<a class="dropdown-item" href="http://localhost/rhu/home/profile"><i class="fa fa-user"></i> My Profile</a>

											<div class="dropdown-divider"></div>
											
											<a class="dropdown-item" href="http://localhost/rhu/home/logout"><i class="fa fa-sign-out"></i> Logout </a>
										</div>
									</li>';
								}
								else{
									echo '
										<li class="nav-item">
											<a class="nav-link" href="http://localhost/rhu/auth/login"><i class="fa fa-user"></i> Log in</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="http://localhost/rhu/auth/register"><i class="fa fa-pencil"></i> Register</a>
										</li>';
								}
							?>
