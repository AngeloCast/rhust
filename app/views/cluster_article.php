...
<body>
	...
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active">Read Health Articles</li>
	</ol>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-8 left-blog-info-w3layouts-agileits text-left" style="border: 1px solid #ced4da;">
					<br>
					<form class="form-inline" action="<?=site_url('home/search_cluster');?>" method="post">
						<div class="form-group mb-2">
							<h3 style="text-align: left;"><i class="fa fa-list"></i> HEALTH ARTICLES</h3>
						</div>
