				...
				<div class="col-lg-8 left-blog-info-w3layouts-agileits text-left" style="border: 1px solid #ced4da;">
					...
					<form class="form-inline" action="<?=site_url('home/search_article');?>" method="post">
						<div class="form-group mb-2">
							<h3 style="text-align: left;"><i class="fa fa-list"></i> HEALTH FAQS</h3>
						</div>
					...
					<?php 
						if(empty($data[0])){
				      		...
				      		# code...
								...
								<div class="col-sm-12 blog-grid-left">
										<div class="imgcard">
											<a href="'.site_url('home/faqs/'.$faqs['id']).'"><img class="card_image" src="'.site_url('public/images/'.$faqs['photo']).'"  alt="health faq image" ></a>
											
											<h5><a href="'.site_url('home/faqs/'.$faqs['id']).'">'.$faqs['title'].'</a></h5>
											<div class="shorten">'.$faqs['content'].'</div>
											<div class="sub-meta">					
												<span><i class="fa fa-clock"></i> '.$faqs['date'].'</span>
												<a href="'.site_url('home/faqs/'.$faqs['id']).'" style="float: right; font-size: 14px;" href="">Read More >></a>	
											</div>
											</div>
										</div>
								</div><hr>';
