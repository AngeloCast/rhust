                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="email" class="form-control" value="<?=$data[3]['email']; ?>" name="email" readonly>
                      </div>
                    </div>
                    <hr>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="number" class="form-control" value="<?=$data[3]['cnumber']; ?>" name="cnumber" required>
                      </div>
                    </div>
                    <hr>
                    <div class="form-group row">
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="<?=site_url('admin/change_password');?>" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="password" class="form-control" placeholder="New Password" id="newpassword" name="newpass" required>
                        </div>
                      </div>
                      <hr>
                      <div class="form-group row">
