      ...
      <form action="<?=site_url('auth/login');?>" method="POST">
        <div class="mt-2 text-center">
          ...
          <div class="input-group mb-2 mr-sm-2">
            ...
            <input style="font-size: 15px;"  type="email" name="email" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Enter User Email" required>
          </div>
          ...
          <div class="input-group mb-3 mr-sm-2">
            ...
            <input style="font-size: 15px;"  type="password" name="password" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Enter User Password" required>
